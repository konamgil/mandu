...
### 7.1 v0.11 (Q1 2026) - 일부 완료 ✅

| 항목 | DNA | 예상 공수 | 상태 |
|------|-----|----------|------|
| 플러그인 타입 정의 | DNA-001 | 2일 | ⏳ 대기 |
| 플러그인 레지스트리 | DNA-001 | 3일 | ⏳ 대기 |
| Guard 프리셋 플러그인화 | DNA-001 | 2일 | ⏳ 대기 |
| Filling DI 패턴 | DNA-002 | 3일 | ⏳ 대기 |
...
| 항목 | DNA | 예상 공수 | 상태 |
|------|-----|----------|------|
| 세션 키 유틸 | DNA-004 | 2일 | ⏳ 대기 |
| UTF-16 안전 문자열 | DNA-005 | 1일 | ⏳ 대기 |
| 설정 핫 리로드 | DNA-006 | 3일 | ⏳ 대기 |
| MCP 도구 플러그인 API | DNA-001 | 3일 | ⏳ 대기 |
| 빌드 플러그인 API | DNA-001 | 3일 | ⏳ 대기 |
| **ANSI-aware 테이블** | DNA-011 | 2일 | ⏳ 대기 |
| **Multi-fallback 프로그레스** | DNA-012 | 2일 | ⏳ 대기 |
