...
## 문서 상태 (업데이트: 2026-01-28)

| 문서 | 상태 | 비고 |
|------|------|------|
| `docs/api/api-reference.md` | 신규 | 2026-01-28 생성 |
| `docs/api/api-reference.ko.md` | 신규 | 2026-01-28 생성 |
| `docs/product/01_mandu_product_brief.md` | 이동 | 2026-01-28 루트에서 이동 |
| `docs/architecture/02_mandu_technical_architecture.md` | 이동 | 2026-01-28 루트에서 이동 |
| `docs/guides/03_mandu_coding_agent_prompt_template.md` | 이동 | 2026-01-28 루트에서 이동 |
| `docs/specs/04_mandu_hydration_system.md` | 이동 | 2026-01-28 루트에서 이동 |
