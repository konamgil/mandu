...
export const MANDU_HELP: HelpDefinition = {
  ...
  subcommands: [
    { name: "create", description: "Create a new Mandu project" },
    ...
    { name: "agent", description: "Run context, plan, apply, verify, repair, and sync" },
  ],
  options: [
  ...
  examples: [
    ["mandu create my-app", "Create a new project"],
    ["mandu dev --port 4000", "Start dev server on port 4000"],
    ["mandu build", "Build for production"],
    ["mandu check", "Validate architecture, contracts, tests, and build readiness"],
    ["mandu agent plan \"add a dashboard\"", "Plan a controlled agent change"],
    ["mandu agent verify --changed", "Verify the resulting change"],
  ],
  sections: [
    {
      title: "Command Groups:",
      content: `  Project    create, dev, build, start
  Safety     check
  Agent      agent`,
    },
  ],
